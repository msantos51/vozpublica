export default function EnterprisePage() {
  return (
    <section className="space-y-12">
      ...
      <header className="rounded-[32px] bg-white p-8 shadow-[0_20px_50px_rgba(31,41,55,0.08)]">
      ...
      <section className="space-y-6">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {[
            ...
            <div
              key={segment}
              className="rounded-2xl border border-zinc-200 p-5 text-sm text-zinc-700"
            >
              {segment}
            </div>
          ))}
